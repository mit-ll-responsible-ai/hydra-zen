    ...
    **Support for partial'd targets**
    ...
    def mutable_value(cls, x: _T, *, zen_convert: Optional[ZenConvert] = None) -> _T:
        ...
        if cast in {list, tuple, dict}:
            x = cls.sanitize_collection(x, convert_dataclass=settings["dataclass"])
    ...
    def sanitized_default_value(
        ...
        *,
        ...
        if (
            ...
            for _field in _val_fields:
                if _field.init and hasattr(value, _field.name):
                    ...
                    converted_fields[_field.name] = cls.sanitized_default_value(
                        _val,
        ...
        if pydantic is not None and isinstance(value, pydantic.fields.FieldInfo):
            ...
            return cls.sanitized_default_value(
                _val,
                allow_zen_conversion=allow_zen_conversion,
    ...
    def sanitized_field(
        ...
        *,
        ...
        value = cls.sanitized_default_value(
            value,
            allow_zen_conversion=allow_zen_conversion,
            error_prefix=error_prefix,
            field_name=field_name,
    ...
    def __call__(
        ...
        **kwargs_for_target: Any,
        ...
        if hydra_defaults is not None:
            ...
            hydra_defaults = self.sanitize_collection(
...
def mutable_value(
    ...
    *,
    ...
    >>> HasMutableDefault()
    HasMutableDefault(a_list=[1, 2, 3])"""
    return BuildsFunction.mutable_value(x, zen_convert=zen_convert)
